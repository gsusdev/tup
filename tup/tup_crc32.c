...
static uint32_t getCRC32(uint32_t f_crc, uint8_t f_ata)
{
...
bool tup_crc32_setHwHandler(tup_crc32func_t crc32func_p)
{
	...
	const char testValue[] = { '1', '2', '3', '4', '5', '6', '7', '8', '9' };
	const tup_checksum_t testValidCrc = crc32(testValue, sizeof(testValue));

	const tup_checksum_t candidateResult = crc32func_p(testValue, sizeof(testValue));

	if (candidateResult != testValidCrc)
	{
		return false;
	}
